        ...
        <div className="py-6 md:py-0 md:px-6">
          ...
          <div className="space-y-4">
            <p className="flex items-center">
              ...
              <span>Southwark Council, PO Box 64529, London SE1P 5LX</span>
            </p>
            <p className="flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="flex items-center">
              ...
              <span>support@nest-quest.com</span>
            </p>
            <div>
              <Map />
            </div>
        ...
        >
          ...
          <div>
            ...
            <textarea
              id="message"
              rows="3"
              className="w-full p-3 rounded bg-gray-100 resize-none"
            ></textarea>
          </div>
          <button
            type="submit"
